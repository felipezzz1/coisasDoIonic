...
export class DetalharPage implements OnInit {
  ...
  downloadFile(){
    return this.contato.downloadURL;
  }

  editar(){
    console.log(this.imagem);
    this.contatoFS.editarImagem(this.imagem,this.form_editar.value, this.contato.id)
    .then(()=>{
      this.contatoFS.excluirImagemStorage(this.downloadFile());
